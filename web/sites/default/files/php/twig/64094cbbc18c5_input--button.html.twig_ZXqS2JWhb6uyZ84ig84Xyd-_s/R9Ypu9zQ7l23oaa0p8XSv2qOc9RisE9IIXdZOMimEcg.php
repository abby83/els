...
class __TwigTemplate_489ef8328dbeee25f028c1b45406f1bb8776b2eed7fdcc40530ac2c515a2a18e extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["icon"] ?? null) && ($context["icon_position"] ?? null)) &&  !($context["icon_only"] ?? null))) ? (("icon-" . $this->sandbox->ensureToStringAllowed(($context["icon_position"] ?? null), 30, $this->source))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/contrib/bootstrap/templates/input/input--button.html.twig", "C:\\xampp\\htdocs\\els\\web\\themes\\contrib\\bootstrap\\templates\\input\\input--button.html.twig");
    }
